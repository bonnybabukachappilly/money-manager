...
from app.schemas import RecurringCreateSchema, RecurringResponseSchema
from app.application.accounts import CreateNewAccount


router = APIRouter(prefix='/recurring', tags=['accounts'])
log: logging.Logger = logging.getLogger(__name__)


@router.post(
    path='/new',
    response_model=RecurringResponseSchema,
    status_code=status.HTTP_201_CREATED,
    summary='Create new recurring account [Loan | EMI]')
async def new_account(
        _: Request, body: RecurringCreateSchema, session: SessionDeps,
